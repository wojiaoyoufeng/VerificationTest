...
@implementation SecKenKeychainQuery
...
- (BOOL)save:(NSError *__autoreleasing *)error {
	...
	CFTypeRef accessibilityType = [SecKenKeychain accessibilityType];
...
- (NSMutableDictionary *)query {
	...
	if ([[self class] isSynchronizationAvailable]) {
		...
		switch (self.synchronizationMode) {
			case SeckenSSKeychainQuerySynchronizationModeNo: {
			  value = @NO;
			  break;
			}
			case SeckenSSKeychainQuerySynchronizationModeYes: {
			  value = @YES;
			  break;
			}
			case SeckenSSKeychainQuerySynchronizationModeAny: {
...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	return [NSError errorWithDomain:kSeckenSSKeychainErrorDomain code:code userInfo:userInfo];
}
