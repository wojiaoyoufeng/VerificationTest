...
typedef NS_ENUM(NSUInteger, SeckenSSKeychainQuerySynchronizationMode) {
	SeckenSSKeychainQuerySynchronizationModeAny,
    SeckenSSKeychainQuerySynchronizationModeNo,
    SeckenSSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface SecKenKeychainQuery : NSObject
...
@property (nonatomic) SeckenSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
