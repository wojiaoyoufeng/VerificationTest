...
extern NSString *const kSeckenSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kSeckenSSKeychainAccountKey;
 ...
 */
extern NSString *const kSeckenSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSeckenSSKeychainClassKey;

/** Item description. */
extern NSString *const kSeckenSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSeckenSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kSeckenSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSeckenSSKeychainWhereKey;
 ...
 */
@interface SecKenKeychain : NSObject
