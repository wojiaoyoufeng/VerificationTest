...
@class SeckenGCDAsyncReadPacket;
@class SeckenGCDAsyncWritePacket;
@class SeckenGCDAsyncSocketPreBuffer;

extern NSString *const SCGCDAsyncSocketException;
extern NSString *const SCGCDAsyncSocketErrorDomain;

extern NSString *const SCGCDAsyncSocketQueueName;
extern NSString *const SCGCDAsyncSocketThreadName;

extern NSString *const SCGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const SCGCDAsyncSocketUseCFStreamForTLS;
#endif
...
extern NSString *const SCGCDAsyncSocketSSLPeerID;
extern NSString *const SCGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const SCGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const SCGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const SCGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const SCGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const SCGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define GCDAsyncSocketLoggingContext 65535


enum SCGCDAsyncSocketError
{
...
typedef enum SCGCDAsyncSocketError GCDAsyncSocketError;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

@interface SeckenGCDAsyncSocket : NSObject
...
@protocol SeckenGCDAsyncSocketDelegate
@optional
...
**/
- (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(SeckenGCDAsyncSocket *)sock;
...
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didAcceptNewSocket:(SeckenGCDAsyncSocket *)newSocket;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(SeckenGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(SeckenGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(SeckenGCDAsyncSocket *)sock;
...
**/
- (void)socketDidDisconnect:(SeckenGCDAsyncSocket *)sock withError:(NSError *)err;
...
**/
- (void)socketDidSecure:(SeckenGCDAsyncSocket *)sock;
...
**/
- (void)socket:(SeckenGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
