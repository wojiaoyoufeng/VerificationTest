...
#import "SeckenGCDAsyncUdpSocket.h"
...
NSString *const SCGCDAsyncUdpSocketException = @"GCDAsyncUdpSocketException";
NSString *const SCGCDAsyncUdpSocketErrorDomain = @"GCDAsyncUdpSocketErrorDomain";

NSString *const SCGCDAsyncUdpSocketQueueName = @"GCDAsyncUdpSocket";
NSString *const SCGCDAsyncUdpSocketThreadName = @"GCDAsyncUdpSocket-CFStream";
...
@interface SeckenGCDAsyncUdpSocket ()
{
	...
	SCGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	SCGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
...
@implementation SeckenGCDAsyncUdpSocket
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([SCGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:SCGCDAsyncUdpSocketErrorDomain
...
- (NSError *)sendTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDAsyncUdpSocketSendTimeoutError",
	                                                     @"SeckenGCDAsyncUdpSocket", [NSBundle mainBundle],
...
- (NSError *)socketClosedError
{
	...
	return [NSError errorWithDomain:SCGCDAsyncUdpSocketErrorDomain code:GCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	GCDAsyncUdpSendPacket *packet = [[GCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [SeckenGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(SCGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(SCGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	SCGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)setReceiveFilter:(SCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(SCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	SCGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:SCGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(SeckenGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(SeckenGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		SeckenGCDAsyncUdpSocket *asyncUdpSocket = (__bridge SeckenGCDAsyncUdpSocket *)pInfo;
