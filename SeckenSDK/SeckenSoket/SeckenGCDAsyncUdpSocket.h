...
extern NSString *const SCGCDAsyncUdpSocketException;
extern NSString *const SCGCDAsyncUdpSocketErrorDomain;

extern NSString *const SCGCDAsyncUdpSocketQueueName;
extern NSString *const SCGCDAsyncUdpSocketThreadName;

enum SCGCDAsyncUdpSocketError
{
...
typedef enum SCGCDAsyncUdpSocketError GCDAsyncUdpSocketError;
 ...
 * 
**/
typedef BOOL (^SCGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^SCGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface SeckenGCDAsyncUdpSocket : NSObject
...
**/
- (void)udpSocket:(SeckenGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(SeckenGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(SeckenGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(SeckenGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(SeckenGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(SeckenGCDAsyncUdpSocket *)sock withError:(NSError *)error;
